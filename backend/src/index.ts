...
app.post("/dashboard/register", checkToken, async (req: Request, res: Response) => {
...
connect(`mongodb+srv://${dbUser}:${dbPass}@cluster0.uneus.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`)
  .then(() => {
    app.listen(3002, () => {
