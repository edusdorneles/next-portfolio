...
<p align="center">Este é o meu portfólio online, desenvolvido com React, TypeScript e NodeJS.<p>
...
<a href="https://www.dududornelees.com.br">
    <img alt="Portfólio GIF" title="Portfólio GIF" src="./client/github/Portfolio.gif" width="100%" />
</a>
...
$ cd react-portfolio
# Crie um arquivo .env em server e insira as informações do MongoDB
$ cd server / > .env
# Crie um arquivo .env em client e insira as informações do EmailJS
$ cd client / > .env
# Instale as dependencias de ambas pastas
$ cd client > yarn / cd server > yarn
# Inicie a aplicação
$ cd client > yarn start / cd server > yarn dev
